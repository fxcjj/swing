...
public class JTabbedPaneTest {
	...
	public static void main(String[] args) {
        ...
        tabbedPane.addTab("Tab02", new ImageIcon("D:\\bill\\swing\\src\\main\\resources\\icon_1.png"), createTextPanel("TAB 02"));

        // 创建第 3 个选项卡（选项卡包含 标题、图标 和 tip提示）
        tabbedPane.addTab("Tab03", new ImageIcon("D:\\bill\\swing\\src\\main\\resources\\icon_1.png"), createTextPanel("TAB 03"), "This is a tab.");
